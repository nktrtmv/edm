...
public static class ConcurrencyTokenConverterFrom<T>
{
    ...
    public static ConcurrencyToken<T> FromUtcDateTime(DateTime concurrencyToken)
    {
        UtcDateTime<T> value = UtcDateTimeConverterFrom<T>.FromUtcDateTime(concurrencyToken);
