...
namespace Edm.Entities.Signing.Workflows.Application.SigningWorkflows.Actions.Commands.PutIntoEffect;

[UsedImplicitly]
internal sealed class PutIntoEffectSigningActionCommandInternalHandler : IRequestHandler<PutIntoEffectSigningActionCommandInternal>
{
    public PutIntoEffectSigningActionCommandInternalHandler(SigningWorkflowsFacade workflows)
    {
        Workflows = workflows;
    }
    ...
    public async Task Handle(PutIntoEffectSigningActionCommandInternal request, CancellationToken cancellationToken)
    {
        ...
        SigningActionsProcessor.PutIntoEffect(context);
