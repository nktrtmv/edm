...
using Edm.Document.Searcher.GenericSubdomain.Enrichers.Inheritors.Enums.Values;

namespace Edm.Document.Searcher.GenericSubdomain.Enrichers.Inheritors.Enums.Targets;
