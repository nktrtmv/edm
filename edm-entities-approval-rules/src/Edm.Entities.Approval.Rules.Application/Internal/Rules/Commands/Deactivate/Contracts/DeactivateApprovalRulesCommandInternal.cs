...
namespace Edm.Entities.Approval.Rules.Application.Internal.Rules.Commands.Deactivate.Contracts;

public sealed class DeactivateApprovalRulesCommandInternal : IRequest
{
    public DeactivateApprovalRulesCommandInternal(
