...
{
    public static T? Convert<T, TSource>(TSource source, bool hasValue, Func<TSource, T> converter, RequireClass<T>? _ = null)
        where T : class
    {
        if (!hasValue)
        {
    ...
    public static T? Convert<T, TSource>(TSource source, bool hasValue, Func<TSource, T> converter, RequireStruct<T>? _ = null)
        where T : struct
    {
        if (!hasValue)
        {
