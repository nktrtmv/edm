...
// TODO: WHAT IS IT AND WHY IT IS HERE?

public sealed class ConditionOneOf : ConditionBase
{
    ...
    public ConditionOneOf(ConditionData data) : base(data)
    {
    }
    ...
    protected override ConditionResult OnCheck(DocumentAttributeValue[] attributesValues)
    {
        ...
        Id<DocumentAttribute>[] notValid = linkedAttributeValues
